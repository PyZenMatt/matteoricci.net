...
3. style
    ...
    Usi principali:
        ...
        Esempio: <p style="color: red; font-size: 16px;">Testo rosso</p>.
...
4. title
    ...
    Usi principali:
        ...
        Esempio: ```html<a href="https://esempio.com" title="Vai a Esempio.com">Link</a>'''.
...
5. lang
    ...
    Usi principali:
        ...
        Questo è un testo in italiano.</p>.
...
6. data-* (Attributi personalizzati)
    ...
    Usi principali:
        ...
        ```html <div data-user-id="123" data-role="admin">Contenuto utente</div>```
