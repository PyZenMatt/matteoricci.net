...
author: Teo
categories: HTML, tutorial, sviluppo web, linguaggio HTML, guida_html
...
- [**struttura** di base di una pagina **HTML**]({{ site.baseurl }}/introduzione-e-capitolo-1/) (`<!DOCTYPE **HTML**>`, `<**HTML**>`, `<head>`, `<body>`).

## Elementi di base **HTML**
- [**tag** e attributi]({{ site.baseurl }}/elementi-di-base/)
- [Principali **tag** strutturali]({{ site.baseurl }}/elementi-di-base/): `<h1>` - `<h6>`, `<p>`, `<div>`, `<span>`, `<br>`, `<hr>`


## Testo e formattazione
- [**tag** per la formattazione del testo]({{ site.baseurl }}/testo-e-formattazione/): `<strong>`, `<em>`, `<b>`, `<i>`, `<u>`, `<small>`, `<mark>`. 
- [Liste]({{ site.baseurl }}/testo-e-formattazione/): `<ul>`, `<ol>`,`<li>`./ 

## Link e immagini
- [Creare collegamenti ipertestuali con]({{ site.baseurl }}/link-e-immagini/) `<a href="">`
- [Inserire immagini con `<img src="" alt="">` e proprietà per gestire dimensioni e testo alternativo.]({{ site.baseurl }}/link-e-immagini/)

## Formattazione semantica
- [Uso dei **tag** semantici]({{ site.baseurl }}/formattazione-semantica/): `<header>`, `<footer>`, `<nav>`, `<section>`, `<article>`, `<aside>`, `<main>`. 

## Tabelle **HTML**
- [Creazione di tabelle con]({{ site.baseurl }}/tabelle-**HTML**/) `<table>`, `<tr>`, `<td>`, `<th>`, `<thead>`, `<tbody>`, `<tfoot>`. 
...
## Multimedia in **HTML**
- [Inserire audio e video]({{ site.baseurl }}/multimedia-in-**HTML**/): `<audio>` e `<video>`.
- [Attributi per gestire il comportamento dei media]({{ site.baseurl }}/multimedia-in-**HTML**/): controls, autoplay, loop, muted.

## Incorporazione di altri contenuti
- [Incorporare contenuti esterni come mappe o video con]({{ site.baseurl }}/incorporazione-di-altri-contenuti/) `<iframe>`.

## Accessibilità in **HTML**
- [Best practices per rendere il contenuto accessibile]({{ site.baseurl }}/accessibilita/): alt nelle immagini, aria-* attributes. 

## **HTML** e SEO (Search Engine Optimization)
- [Come usare **HTML** per migliorare la SEO come meta **tag**]({{ site.baseurl }}/**HTML**-e-seo/): `<meta>`, descrizioni, parole chiave. 
- [Importanza della **struttura** semantica per il ranking]({{ site.baseurl }}/**HTML**-e-seo/)
...
Questi **tag** permettono di descrivere vari elementi, come titoli, paragrafi, immagini, link, e formati di testo. Inoltre, **HTML** include una serie di attributi che aggiungono informazioni extra ai **tag**, come il colore o la dimensione di un testo.
**struttura** di base di una pagina **HTML**
